...
student_data=[Row(name='James, Smith',language=['Java','Scala','C++'], state='CA'),
              Row(name='Michael, Rose',language=['Spark','Java','C++'], state='NJ'),
              Row(name='Robert, Williams',language=['CSharp','VB'], state='NV')]
