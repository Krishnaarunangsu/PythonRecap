...
from pyspark.sql.functions import sum,count,avg,mean, max, expr, log
...
salary_incr="salary*2"
employee_dataframe=employee_dataframe.withColumn("salary_log", log(employee_dataframe["salary"]))
employee_dataframe.show()